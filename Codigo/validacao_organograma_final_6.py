...
CAMINHO_PPTX = r"C:\Automacao\Organograma_Bradesco Payments_Jul26.pptx"
CAMINHO_FENIX = r"C:\Automacao\Base_Fenix_Payments.xlsx"
CAMINHO_SAIDA = r"C:\Automacao\relatorio_organograma_Payments.xlsx"
...
def main():
    ...
    for _, r in fenix.iterrows():
        ...
        if m is None:
            ...
            # 'Area=' na própria caixa de FUNCIONÁRIOS/ESTAGIÁRIOS dela - o
            # nível mais específico, direto de onde ela está listada.
            ...
            if not chain and len(fenix_check_values) == 0:
                ...
                # Cada nível da cadeia do PPT precisa bater com algum valor do
                # Fênix - mas com 1 nível de tolerância, pra não falhar por
                # causa de um rótulo de produto/classificação a mais no topo
                # que o Fênix não rastreia (ex: "PRODUTOS PAGAMENTOS").
        ...
        results.append(dict(
            ...
            area_pptx=area_pptx, status_area=status_area,
